classdef wheresWhaledo < handle
    ...
    methods
        ...
        function setParams(obj, params)
            [obj.params.wheresWhaledoPath, ~] = fileparts(mfilename('fullpath'));
        ...
        function buildPanels(obj)
            obj.arrayPanel = gui.arrayPanel(obj, obj.params.panelPositions(1, :), obj.params);
            obj.detectorPanel = gui.detectorPanel(obj, obj.params.panelPositions(2, :), obj.params); 
            obj.localizePanel = gui.localizePanel(obj, obj.params.panelPositions(3, :), obj.params);
        end
